	...
	<div class="home-container clearfix">
		...
		<div class="menu-left clearfix">
			<ul class="menu-list" :class="{isCollapse}">
				<li class="menu-item" v-for="(item, index) in menuList" :key="index" @click="addChart(item)">{{item.name}}</li>
			</ul>
					...
					<el-menu class="el-menu-vertical-demo" background-color="#545c64" text-color="#fff" :unique-opened="true">
						...
						<el-submenu index="2">
							...
							<el-form ref="form" class="option-list" :model="titleForm" label-width="80px">
								...
								<el-form-item class="option-item" label="字体大小">
									<el-input-number v-model="titleForm.size" size="mini" :controls="false" controls-position='right' :min="12" :max="40"></el-input-number>
								</el-form-item>
						...
						<el-submenu index="3">
							...
							<el-form ref="form" class="option-list" :model="xAsixForm" label-width="90px">
								...
								<el-form-item class="option-item" label="字体大小">
									<el-input-number v-model="xAsixForm.size" size="mini" :controls="false" controls-position='right' :min="12" :max="40"></el-input-number>
								</el-form-item>
							</el-form>
						</el-submenu>
						<el-submenu index="4">
							...
							<el-form ref="form" class="option-list" :model="yAsixForm" label-width="90px">
								...
								<el-form-item class="option-item" label="字体大小">
									<el-input-number v-model="yAsixForm.size" size="mini" :controls="false" controls-position='right' :min="12" :max="40"></el-input-number>
								</el-form-item>
							</el-form>
						</el-submenu>
						<el-submenu index="5">
							...
							<el-form ref="form" class="option-list" :model="tipNumForm" label-width="90px">
								...
								<el-form-item class="option-item" label="字体大小">
									<el-input-number v-model="tipNumForm.size" size="mini" :controls="false" controls-position='right' :min="12" :max="40"></el-input-number>
								</el-form-item>
								<el-form-item class="option-item" label="字体颜色">
						...
						<el-submenu index="6">
							...
							<el-form ref="form" class="option-list" :model="tipLangForm" label-width="90px">
								...
								<el-form-item class="option-item" label="字体大小">
									<el-input-number v-model="tipLangForm.size" size="mini" :controls="false" controls-position='right' :min="12" :max="40"></el-input-number>
								</el-form-item>
								<el-form-item class="option-item" label="字体颜色">
						...
						<el-submenu index="8">
							...
							<el-form ref="form" class="option-list" :model="legendForm" label-width="90px">
								...
								<el-form-item class="option-item" label="图例宽度">
									<el-input-number v-model="legendForm.width" size="mini" :controls="false" controls-position='right' :min="12" :max="40"></el-input-number>
								</el-form-item>
								...
								<el-form-item class="option-item" label="字体大小">
									<el-input-number v-model="legendForm.size" size="mini" :controls="false" controls-position='right' :min="12" :max="40"></el-input-number>
								</el-form-item>
							</el-form>
						</el-submenu>
						<el-submenu index="9">
